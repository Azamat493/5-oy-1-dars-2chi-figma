    ...
    <section className="product-section">
      <div className="container">
        <div className="section-header">
          <h2 className="section-title">The Product we work with.</h2>
        ...
        <div className="product-grid">
          <div className="product-card">
            <div className="product-icon icon-cross">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <h3 className="product-title">Cross platform</h3>
            <p className="product-text">
              Elit esse cillum dolore eu fugiat nulla pariatur
            </p>
          </div>
          <div className="product-card">
            <div className="product-icon icon-cloud">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <h3 className="product-title">Cloud server</h3>
            <p className="product-text">
              Elit esse cillum dolore eu fugiat nulla pariatur
            </p>
            <svg
          ...
          <div className="product-card">
            <div className="product-icon icon-js">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <h3 className="product-title">Pure Javascript</h3>
            <p className="product-text">
              Elit esse cillum dolore eu fugiat nulla pariatur
            </p>
          </div>
